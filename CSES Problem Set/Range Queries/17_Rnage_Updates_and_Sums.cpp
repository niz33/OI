...
class SegmentTree{
    ...
    void maintain(int r,int rl,int rr){
        ...
        if(rLazySet[r]){
            ...
            rSum[r*2]=((long long)(rm-rl))*rLazySet[r];
            rSum[r*2+1]=((long long)(rr-rm))*rLazySet[r];
            ...
            rSum[r*2]+=((long long)(rm-rl))*rLazyAdd[r];
            rSum[r*2+1]+=((long long)(rr-rm))*rLazyAdd[r];
            rLazyAdd[r]=0;
        }
